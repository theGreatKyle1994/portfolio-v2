    ...
    <Card title={"About Me"}>
      <section className={"aboutMeContainer"}>
        <p className={"aboutMe"}>
          ...
          facilitate mutual development. As a current Project Lead, I similarly
          engage my colleagues in one-on-one code review in addition to hosting
          Agile based meetings to ensure adherence to project deadlines and to
          discuss continuous growth. My personal skill set utilizes several
          essential technologies in the production pipeline, including:
          JavaScript, TypeScript, Python and a specialty in React. I look
          forward to assisting you in developing a unique web identity for your
          brand, special event, organization, or yourself!
        </p>
        <a
          target={"_blank"}
          rel="noreferrer"
